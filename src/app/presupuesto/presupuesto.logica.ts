...
@Component({
  ...
  templateUrl: './presupuesto.pagina.html',
  styleUrls: ['./presupuesto.pagina.scss'],
})
export class PresupuestoPage implements OnInit {
  ...
  guardar(){
    ...
    if (this.monto!= null && this.selectedValue!= null && this.descripcion!= null && this.monto > 0 && this.descripcion!= '') {
      ...
      this.results = 'Tipo de Gasto: '+this.selectedValue+'; Monto: '+this.monto+'; Descripcion: '+this.descripcion;
