...
,'2 Ramitas de Cilantro fresco desinfectadas y picadas finamente'
    ...
    {
      id: 5, 
      nombre: 'Empanadas de Atun', 
      image: 'https://cdn2.cocinadelirante.com/sites/default/files/styles/gallerie/public/images/2023/02/receta-empanadas-de-atun.jpg',
      ingredientes: [
...
,'1 pimiento rojo'
,'2 huevos (cocido y uno para barnizar)'
      ]
    }
  ];
